...
<body class="<?php print my_theme_body_class($is_front, $logged_in, $is_admin, $node, $left, $right); ?>">
  <div id="header">
  ...
  <div id="footer">
    <div class="container_16">
      ...
      <div id="theme-credits" class="grid_16">
        <?php print t('Modified <a href="@my_theme-project">My_theme</a> Drupal theme  by <a href="@wolfflow">Wolfflow</a>.', array('@my_theme-project' => url('http://theme.thanage.eut/'), '@wolfflow' => url('http://sponsor.thanage.eu/wolfflow'))) ?>
      </div>
